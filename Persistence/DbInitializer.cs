...
{
  /**
  The reason static is 
  we do not need to create a new instance of the DB initializer.
  You cannot treat static methods like object references - they don’t need new.
  */
